...
mkdir "%APPDATA%\codeinterviewassist-v1\temp" 2>nul
mkdir "%APPDATA%\codeinterviewassist-v1\cache" 2>nul
mkdir "%APPDATA%\codeinterviewassist-v1\screenshots" 2>nul
mkdir "%APPDATA%\codeinterviewassist-v1\extra_screenshots" 2>nul
