#!/bin/bash
echo "=== CodeInterviewAssist - Invisible Edition (No Paywall) ==="
echo
...
mkdir -p ~/Library/Application\ Support/codeinterviewassist-v1/temp
mkdir -p ~/Library/Application\ Support/codeinterviewassist-v1/cache
mkdir -p ~/Library/Application\ Support/codeinterviewassist-v1/screenshots
mkdir -p ~/Library/Application\ Support/codeinterviewassist-v1/extra_screenshots
